...
class TwoJarsState:
    ...
    def legalMoves( self ):
        ...
        if j4 != 0:
            lista_movlegais.append('emptyJ4')
        if j3 != 0:     
            lista_movlegais.append('emptyJ3')
        if j4 == 0 or j4 < 4:
             lista_movlegais.append('fillJ4')
        if j4 == 4 or j4 < 4: 
            lista_movlegais.append('pourJ4intoJ3')
        if j3 == 0 or 0 < j3 < 3:
            lista_movlegais.append('fillJ3')
        if j3 == 3 or 0 < j3 < 3: 
            lista_movlegais.append('pourJ3intoJ4')

        lista_movlegais = list(dict.fromkeys(lista_movlegais))

        return lista_movlegais
    ...
    def __getAsciiString(self):
        ...
        output = []
        rowLine = "( J4: " + self.jars[0].__str__()  + ", J3: "+ self.jars[1].__str__() +" )"
