...
class CornersProblem(search.SearchProblem):
    ...
    def __init__(self, startingGameState):
        ...
        "Q4"
        self.startPosition = tuple([0,0,0,0])
    ...
    def getStartState(self):
        ...
        "Eduardo Freitas Moura - 1911987BCC"
        "Q4"
        return(self.startingPosition, self.startPosition)
    ...
    def getNextState(self, state, action):
        ...
        # you will need to replace the None part of the following tuple.
            return ((nextx, nexty), tuple(corner))
        util.raiseNotDefined()
    ...
    if problem.isGoalState(state):
        ...
        for i,j in enumerate(state[1]):
            if j == 0:
                xy1 = state[0]
                xy2 = corners[i]
                dist_corner.append(abs(xy1[0] - xy2[0]) + abs(xy1[1] - xy2[1])) #Distância ManhattanHeuristic
        return max(dist_corner)
...
class ClosestDotSearchAgent(SearchAgent):
    ...
    def findPathToClosestDot(self, gameState):
        ...
        "Eduardo Freitas Moura - 1911987BCC"
        "Q7"
        busca = search.aStarSearch(problem)
        return busca
        util.raiseNotDefined()
